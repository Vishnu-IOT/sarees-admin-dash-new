...
export const getProducts = (page = 1, limit = 10) =>
  client.get(`/products/get-products?page=${page}&limit=${limit}`).then((res) => res.data);

// GET /products/get-sarees?page=&limit=
export const getSarees = (page = 1, limit = 10) =>
  client.get(`/products/get-sarees?page=${page}&limit=${limit}`).then((res) => res.data);

// GET /products/get-jewels?page=&limit=
export const getJewels = (page = 1, limit = 10) =>
  client.get(`/products/get-jewels?page=${page}&limit=${limit}`).then((res) => res.data);
...
export const getProductById = (id) =>
  client.get(`/products/get-product/${id}`).then((res) => res.data || []
