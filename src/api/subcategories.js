...
export const getSubCategoriesByCollection = (collection) =>
  client.get(`/category/get-subcategories/${collection}`).then((res) => res.data || []);

// GET /category/get-subcategories-by-category/:categoryId
export const getSubCategoriesByCategoryId = (categoryId) =>
  client.get(`/category/get-subcategories-by-category/${categoryId}`).then((res) => res.data || []);
...
export const updateSubCategory = (id, payload) =>
  client.post(`/category/update-subcategory/${id}`, payload).then((res) => res.data);
